...
func (c *Client) GetOrganizationByName(name string) (*entities.Organization, *http.Response, *hcloud.ErrorResponse) {
...
func (c *Client) DeleteOrganizationByName(name string) (*http.Response, *hcloud.ErrorResponse) {
	resp, _, err := c.client.Delete(c.getEndpoint() + "/v1/org/" + name)
	if err != nil {
		return nil, err
	}
