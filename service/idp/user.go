...
func (c *Client) GetUserEmail() (*entities.UserEmail, *http.Response, *hcloud.ErrorResponse) {
	resp, body, err := c.client.Get(c.getEndpoint() + fmt.Sprintf("/v1/user/email"))
	if err != nil {
		return nil, nil, err
	}
...
func (c *Client) DeleteUser() (*entities.User, *http.Response, *hcloud.ErrorResponse) {
	resp, body, err := c.client.Delete(c.getEndpoint() + fmt.Sprintf("/v1/user"))
	if err != nil {
		return nil, nil, err
	}
...
func (c *Client) DeleteUserSessions() (*http.Response, *hcloud.ErrorResponse) {
	resp, _, err := c.client.Delete(c.getEndpoint() + fmt.Sprintf("/v1/user/sessions"))
	if err != nil {
		return nil, err
	}
...
func (c *Client) PatchUser(user *entities.PatchUser) (*entities.User, *http.Response, *hcloud.ErrorResponse) {
	resp, body, err := c.client.Patch(c.getEndpoint()+fmt.Sprintf("/v1/user"), *user)
	if err != nil {
		return nil, nil, err
	}
