...
func (c *Client) GetApps(organization string, limit int, page int) (*[]entities.High5App, entities.Total, *http.Response, *hcloud.ErrorResponse) {
...
func (c *Client) GetApp(organization string, app string) (*entities.High5App, *http.Response, *hcloud.ErrorResponse) {
...
func (c *Client) CreateApp(organization string, app *entities.AppCreation) (*entities.High5App, *http.Response, *hcloud.ErrorResponse) {
...
func (c *Client) PatchAppPermissions(organization string, app string, permission *entities.AppPermissionPatch) (*entities.High5App, *http.Response, *hcloud.ErrorResponse) {
